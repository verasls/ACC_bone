...
Bone reponds to mechanical loading by altering its properties, such as density, geometry, and strength [@Turner2003; @Fonseca2014; @Santos2017]. Physical activity is a way of eliciting mechanical stimuli, and it is well established to improve bone health. However, there is no consensus in which characteristics of the physical activity-related mechanical stimulus are better associated with bone health benefits. Nevertheless, there is evidence that that high-impact exercise, although performed scarcely throughout the day, may play an important role in inducing positive bone adaptations [@Vainionpaa2006; @Stiles2017].

But, even when knowing precisely which the best loading regimen is to improve bone health, the question of how to measure and monitor this load remains. Bone mechanical loading is usually measured in laboratory settings, using instruments such as force plates (FP) [@Medved2000]. Measurements in these instruments, that are confined to a laboratory space, are not applicable to controling the loads a person is routinely subjected in free-living contexts. To surpass this issue, in the last few years, methods using wearable devices such as accelerometers have been proposed to measure mechanical loading, more precisely,  ground reaction force (GRF) [@Neugebauer2012; @Neugebauer2014; @Fortune2014; @Neugebauer2018; @Veras2020] and loading rate (LR) [@Fortune2014; @Veras2020]. These devices are light, small, can be used throughout days, and have a relatively affordable price. The aforementioned characteristics make the accelerometers well suited instruments to measure mechanical loading on a daily basis.

However, the validity of the accelerometer-predicted mechanical loading values depends on some factors, as the sample characteristics [@Welk2005]. In fact, due to this, several calibration studies have been done in several populations, as children [@Neugebauer2012], adults [@Neugebauer2014; @Fortune2014], military personnel [@Neugebauer2018], and subjects with obesity [@Veras2020]. Another important factor that influences the predictions validity is the type of activities performed in the calibration study [@Bassett2012]. Until now, studies that calibrate accelerometers to predict mechanical loading variables have usually employed activities as walking [@Fortune2014; @Neugebauer2018; @Veras2020], or walking and running [@Neugebauer2012; @Neugebauer2014]. Nevertheless, activities eliciting higher impact loads have not yet been tested.

Therefore, the objective of this study was to develop accelerometry-based mechanical loading prediction equations for high-impact activites in subjects from normal weight to severe obesity.
