...
Bone is known to increase its tissue mass and enhance its micro-architecture arrangement in response to mechanical stimulation, particularly at higher magnitudes. This type of high-intensity impact activies have shown to be more associated with bone health improval, even if they are usually performed in low quantities throughout the day. In fact, Vainionpaa et al demonstrated that performing a relatively low number of pACC above 4.9*g* daily is positively associated with increases in bone mineral density. Usually, this acceleration magnitude can only be achieved by explosive (?) movements such as jumps. Nevertheless, accelerometry-based mechanical loading regression models have mostly been validated with a set of activies, such as walking and running, that elict relatively low acceleration magnitudes, usually ranging from X to Y*g*.
